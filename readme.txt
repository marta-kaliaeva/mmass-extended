...
This is an extended version of mMass that was originally written by Martin Strohalm (https://github.com/xxao/mMass).
The modifications have primarily affected the compound search functionality. However, there are also some GUI changes.
...
František Malinka, Marta Kaliaeva, Lukáš Drahník, Lukáš Kučera
