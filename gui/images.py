...
def scaleBitmap(bitmap, size):
    return wx.ImageFromBitmap(bitmap).Scale(size[0], size[1]).ConvertToBitmap()
...
def loadImages():
    ...
    if wx.Platform == '__WXMAC__':
        ...
        toolsBitmapSize = (30, 30) # initially was 22,22

        lib['toolsOpen'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(0, 0, 22, 22)), toolsBitmapSize)
        lib['toolsSave'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(22, 0, 22, 22)), toolsBitmapSize)
        lib['toolsPrint'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(44, 0, 22, 22)), toolsBitmapSize)
        lib['toolsProcessing'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(66, 0, 22, 22)), toolsBitmapSize)
        lib['toolsCalibration'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(88, 0, 22, 22)), toolsBitmapSize)
        lib['toolsSequence'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(110, 0, 22, 22)), toolsBitmapSize)
        lib['toolsMassCalculator'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(132, 0, 22, 22)), toolsBitmapSize)
        lib['toolsCompoundsSearch'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(154, 0, 22, 22)), toolsBitmapSize)
        lib['toolsPeakDifferences'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(176, 0, 22, 22)), toolsBitmapSize)
        lib['toolsComparePeaklists'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(198, 0, 22, 22)), toolsBitmapSize)
        lib['toolsMascot'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(220, 0, 22, 22)), toolsBitmapSize)
        lib['toolsProfound'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(242, 0, 22, 22)), toolsBitmapSize)
        lib['toolsDocumentInfo'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(264, 0, 22, 22)), toolsBitmapSize)
        lib['toolsDocumentReport'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(286, 0, 22, 22)), toolsBitmapSize)
        lib['toolsDocumentExport'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(308, 0, 22, 22)), toolsBitmapSize)
        lib['toolsPresets'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(330, 0, 22, 22)), toolsBitmapSize)
        lib['toolsMassFilter'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(352, 0, 22, 22)), toolsBitmapSize)
        lib['toolsSpectrumGenerator'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(374, 0, 22, 22)), toolsBitmapSize)
        lib['toolsEnvelopeFit'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(396, 0, 22, 22)), toolsBitmapSize)
        lib['toolsLibrary'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(418, 0, 22, 22)), toolsBitmapSize)
        lib['toolsMassToFormula'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(440, 0, 22, 22)), toolsBitmapSize)
        lib['toolsPeriodicTable'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(462, 0, 22, 22)), toolsBitmapSize)
        lib['toolsMassDefectPlot'] = scaleBitmap(tools.GetSubBitmap(wx.Rect(484, 0, 22, 22)), toolsBitmapSize)
    ...
    bottombarBitmapSize = (36, 27) # initially was 29,22 (36, 27)

    lib['documentsAdd'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(0, 0, 29, 22)), bottombarBitmapSize)
    lib['documentsDelete'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(29, 0, 29, 22)), bottombarBitmapSize)
    
    lib['peaklistAdd'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(0, 22, 29, 22)), bottombarBitmapSize)
    lib['peaklistDelete'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(29, 22, 29, 22)), bottombarBitmapSize)
    lib['peaklistAnnotate'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(58, 22, 29, 22)), bottombarBitmapSize)
    lib['peaklistEditorOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(87, 22, 29, 22)), bottombarBitmapSize)
    lib['peaklistEditorOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(87, 22, 29, 22)), bottombarBitmapSize)
    
    lib['spectrumLabelsOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(0, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelsOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(0, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumTicksOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(29, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumTicksOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(29, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumNotationsOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(58, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumNotationsOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(58, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelAngleOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(87, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelAngleOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(87, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumPosBarsOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(116, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumPosBarsOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(116, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumGelOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(145, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumGelOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(145, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumTrackerOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(174, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumTrackerOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(174, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumAutoscaleOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(203, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumAutoscaleOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(203, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumNormalizeOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(232, 44, 29, 22)), bottombarBitmapSize)
    lib['spectrumNormalizeOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(232, 44, 29, 22)), bottombarBitmapSize)
    
    lib['spectrumRulerOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(0, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumRulerOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(0, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelPeakOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(29, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelPeakOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(29, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelPointOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(58, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelPointOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(58, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelEnvelopeOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(87, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumLabelEnvelopeOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(87, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumDeleteLabelOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(116, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumDeleteLabelOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(116, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumOffsetOn'] = scaleBitmap(bottombarsOn.GetSubBitmap(wx.Rect(145, 66, 29, 22)), bottombarBitmapSize)
    lib['spectrumOffsetOff'] = scaleBitmap(bottombarsOff.GetSubBitmap(wx.Rect(145, 66, 29, 22)), bottombarBitmapSize)
    
    # toolbars
    toolbarsOn = images_lib.getToolbarsOnBitmap()
    toolbarsOff = images_lib.getToolbarsOffBitmap()
    
    # $$ all rows with scaleBitmap(toolbarsOn/Off...)
    toolbarsBitmapSize = (36, 27) # initially was 29,22

    lib['compoundsSearchCompoundsOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 0, 29, 22)), toolbarsBitmapSize)
    lib['compoundsSearchCompoundsOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 0, 29, 22)), toolbarsBitmapSize)
    lib['compoundsSearchFormulaOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 0, 29, 22)), toolbarsBitmapSize)
    lib['compoundsSearchFormulaOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 0, 29, 22)), toolbarsBitmapSize)
    
    lib['calibrationReferencesOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 22, 29, 22)), toolbarsBitmapSize)
    lib['calibrationReferencesOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 22, 29, 22)), toolbarsBitmapSize)
    lib['calibrationErrorsOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 22, 29, 22)), toolbarsBitmapSize)
    lib['calibrationErrorsOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 22, 29, 22)), toolbarsBitmapSize)
    
    lib['documentExportImageOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 44, 29, 22)), toolbarsBitmapSize)
    lib['documentExportImageOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 44, 29, 22)), toolbarsBitmapSize)
    lib['documentExportPeaklistOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 44, 29, 22)), toolbarsBitmapSize)
    lib['documentExportPeaklistOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 44, 29, 22)), toolbarsBitmapSize)
    lib['documentExportSpectrumOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 44, 29, 22)), toolbarsBitmapSize)
    lib['documentExportSpectrumOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 44, 29, 22)), toolbarsBitmapSize)
    
    lib['documentInfoSummaryOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 66, 29, 22)), toolbarsBitmapSize)
    lib['documentInfoSummaryOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 66, 29, 22)), toolbarsBitmapSize)
    lib['documentInfoSpectrumOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 66, 29, 22)), toolbarsBitmapSize)
    lib['documentInfoSpectrumOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 66, 29, 22)), toolbarsBitmapSize)
    lib['documentInfoNotesOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 66, 29, 22)), toolbarsBitmapSize)
    lib['documentInfoNotesOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 66, 29, 22)), toolbarsBitmapSize)
    
    lib['mascotPMFOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 88, 29, 22)), toolbarsBitmapSize)
    lib['mascotPMFOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 88, 29, 22)), toolbarsBitmapSize)
    lib['mascotMISOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 88, 29, 22)), toolbarsBitmapSize)
    lib['mascotMISOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 88, 29, 22)), toolbarsBitmapSize)
    lib['mascotSQOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 88, 29, 22)), toolbarsBitmapSize)
    lib['mascotSQOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 88, 29, 22)), toolbarsBitmapSize)
    lib['mascotQueryOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(87, 88, 29, 22)), toolbarsBitmapSize)
    lib['mascotQueryOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(87, 88, 29, 22)), toolbarsBitmapSize)
    
    lib['massCalculatorSummaryOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 110, 29, 22)), toolbarsBitmapSize)
    lib['massCalculatorSummaryOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 110, 29, 22)), toolbarsBitmapSize)
    lib['massCalculatorIonSeriesOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 110, 29, 22)), toolbarsBitmapSize)
    lib['massCalculatorIonSeriesOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 110, 29, 22)), toolbarsBitmapSize)
    lib['massCalculatorPatternOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 110, 29, 22)), toolbarsBitmapSize)
    lib['massCalculatorPatternOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 110, 29, 22)), toolbarsBitmapSize)
    
    lib['processingMathOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingMathOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingCropOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingCropOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingBaselineOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingBaselineOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingSmoothingOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(87, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingSmoothingOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(87, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingPeakpickingOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(116, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingPeakpickingOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(116, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingDeisotopingOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(145, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingDeisotopingOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(145, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingDeconvolutionOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(174, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingDeconvolutionOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(174, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingBatchOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(203, 132, 29, 22)), toolbarsBitmapSize)
    lib['processingBatchOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(203, 132, 29, 22)), toolbarsBitmapSize)
    
    lib['sequenceEditorOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceEditorOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceModificationsOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceModificationsOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceDigestOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceDigestOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceFragmentOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(87, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceFragmentOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(87, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceSearchOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(116, 154, 29, 22)), toolbarsBitmapSize)
    lib['sequenceSearchOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(116, 154, 29, 22)), toolbarsBitmapSize)
    
    lib['profoundPMFOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 176, 29, 22)), toolbarsBitmapSize)
    lib['profoundPMFOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 176, 29, 22)), toolbarsBitmapSize)
    lib['profoundQueryOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 176, 29, 22)), toolbarsBitmapSize)
    lib['profoundQueryOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 176, 29, 22)), toolbarsBitmapSize)
    
    lib['prospectorMSFitOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 176, 29, 22)), toolbarsBitmapSize)
    lib['prospectorMSFitOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 176, 29, 22)), toolbarsBitmapSize)
    lib['prospectorMSTagOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 88, 29, 22)), toolbarsBitmapSize)
    lib['prospectorMSTagOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 88, 29, 22)), toolbarsBitmapSize)
    lib['prospectorQueryOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(58, 176, 29, 22)), toolbarsBitmapSize)
    lib['prospectorQueryOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(58, 176, 29, 22)), toolbarsBitmapSize)
    
    lib['matchErrorsOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(0, 198, 29, 22)), toolbarsBitmapSize)
    lib['matchErrorsOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(0, 198, 29, 22)), toolbarsBitmapSize)
    lib['matchSummaryOn'] = scaleBitmap(toolbarsOn.GetSubBitmap(wx.Rect(29, 198, 29, 22)), toolbarsBitmapSize)
    lib['matchSummaryOff'] = scaleBitmap(toolbarsOff.GetSubBitmap(wx.Rect(29, 198, 29, 22)), toolbarsBitmapSize)
